sap.ui.define([
		...
		return BaseObject.extend("personal.ns.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias personal.ns.model.ListSelector
			 */
			 ...
			 * @return {personal.ns.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
